...
// Test hash
const hash = findHash('haloo')
//Variable:
const a = BigInt(-3)               //the a value of curve y^2 = x^3 + ax + b
const b = BigInt(69424)            //the b value of curve y^2 = x^3 + ax + b
const p = BigInt(114973)           //the modulo (divisor; curve over Zp)
const order = BigInt(114467)     //order of the base point over the curve (G)
const x1 = BigInt(11570)          //x-axis of the base point (x,ty
const y1= BigInt(42257)         //y-axis of the base point (x,y)
const point = [x1, y1]     //base point G
const privKey = BigInt(86109)
const message = BigInt(99)
const k = GenerateRandomNum(order - BigInt(1))
